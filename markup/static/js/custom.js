    ...
    .then((post) => {
        for (let index = 0; index < 8; index++) {
            div.innerHTML += `<div class="__cl-grid__c-12___ __cl-grid__c-to-x-6___ __cl-grid__c-sm-4___ __cl-grid__c-md-4___ __cl-grid__c-xmd-3___">
                    <div class="__cl-c-slot___" tabindex="0"><a class="__cl-c-slot__img-box___" href="#" aria-label="slot picture"><img class="lazyload" src="static/img/general/cork-slot.png" data-src="${post[con].image}" alt=""/></a>
                        <div class="__cl-c-slot__content___">
                            <div class="__cl-c-slot__title___">${post[con].title}</div>
                            <div class="__cl-c-slot__text___">${post[con].category}</div>
                            <div class="__cl-c-slot__value___">
                                <div class="__cl-c-slot__price___">Rp ${post[con].price}</div>
